 ...
 * under the License.
 */
package org.wso2.carbon.identity.authenticator.risk.analytics.internal;

import org.wso2.carbon.context.PrivilegedCarbonContext;
import org.wso2.carbon.event.template.manager.core.TemplateManagerService;

/**
 * Hold the Template Manager Service
 */
public class TemplateManagerConfigurationServiceHolder {
    ...
    public static void setTemplateManagerService(TemplateManagerService templateManagerService) {
        TemplateManagerConfigurationServiceHolder.templateManagerService = templateManagerService;
    }
